...
public abstract class FoodProvider extends ContentProvider {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs) {
        ...
        switch (match) {
            case FOODS:
                cursor = database.query(FoodContract.FoodEntry.TABLE_NAME, projection, selection, selectionArgs, null, null, sortOrder);
                break;

            case CART:
                cursor = database.query(FoodContract.FoodEntry.CART_TABLE, projection, selection, selectionArgs, null, null, sortOrder);
                break;
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (match) {
            case CART_ID:
                ...
                cartDeleted = db.delete(FoodContract.FoodEntry.CART_TABLE, "id=?", new String[]{id});
                break;
                default:
